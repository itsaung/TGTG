"""Vendored copy of py-adyen-encrypt (MIT), patched for current `cryptography`
releases. Upstream: https://github.com/66niko99/py-adyen-encrypt — see LICENSE
in this directory.
"""
...
class encryptor:
    ...
    def decode_adyen_public_key(encoded_public_key):
        ...
        # Vendored patch: upstream calls backend.load_rsa_public_numbers(), removed from
        # the cryptography package. public_key(backend) is the supported equivalent.
